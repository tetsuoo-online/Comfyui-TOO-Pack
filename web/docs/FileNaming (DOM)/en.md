...
Node for saving images with advanced file naming and A1111/Civitai Auto V3 compatible metadata.</br></br>
Same as LiteGraph version, just fancier design; note that right click>Fix node (Recreate) won't work, you will have to refresh instead (F5 or Ctrl+R).
