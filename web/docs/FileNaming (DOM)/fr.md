# 💾 TOO Smart Image Saver (Advanced)(DOM)

Nœud permettant la sauvegarde d'image avec système de nommage avancé et des métadonnées compatibles A1111/Civitai Auto V3.</br></br>

Identique à la version LiteGraph mais avec un design plus élégant; à noter que le right clic>Fix node (Recreate) ne fonctionnera pas, il faudra rafraîchir le canvas (F5 / Ctrl+R).
